   ...
   */
  {
    ...
    items: [
      { title: 'Home', path: paths.dashboard.root, icon: ICONS.dashboard },
      {
        ...
        path: paths.dashboard.general.writing,
        icon: ICONS.ecommerce,
      },
      {
        title: 'PhotoJournalism',
        path: paths.dashboard.general.photojournalism,
        icon: ICONS.analytics,
      },
      { title: 'Design', path: paths.dashboard.general.design, icon: ICONS.banking },
      {
        title: 'Broadcast Journalism',
        path: paths.dashboard.general.broadcast,
        icon: ICONS.booking,
      },
